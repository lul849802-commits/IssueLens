...
describe("validateClusterPlan",()=>{
  ...
  it("conservatively repairs duplicate, unknown, and missing assignments", () => {
    expect(normalizeClusterPlan({
      clusters: [{
        ...valid.clusters[0],
        memberRunIssueIds: [a, b, b],
      }],
      ...
      clusters: [{ ...valid.clusters[0], memberRunIssueIds: [a, b] }],
      unclusteredRunIssueIds: [c],
    });
  });
});
